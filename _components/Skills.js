              ...
              {skills.map((skill) => (
                <div
                  ...
                  <div className='flex items-center gap-2 md:justify-between md:gap-0'>
                    ...
                    />
                    <span className='font-semibold text-slate-700 dark:text-body-text-dark text-sm md:text-base lg:text-lg'>
                      {skill.name}
                    </span>
                  </div>
                </div>
          ...
          <div>
            ...
            <div className='space-y-3 md:space-y-4 mb-6'>
              <div className='flex items-center gap-3 md:gap-4 bg-white dark:bg-slate-800/50 p-3 md:p-4 rounded-2xl shadow-sm border border-pink-100/50'>
                ...
                <span className='font-medium text-slate-700 dark:text-body-text-dark text-sm md:text-base lg:text-lg'>
                  {t.soft1}
                </span>
              </div>
